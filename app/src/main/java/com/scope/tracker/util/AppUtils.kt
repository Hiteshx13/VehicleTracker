...
import com.scope.tracker.util.Constants.Companion.PREF_NAME
import com.scope.tracker.util.Constants.Companion.SAVED_DATE
...
object AppUtils {
    ...
    fun calculateDistance(locationSource:Location,locationDestination:Location):Float{
       return locationSource.distanceTo(locationDestination)
    }
